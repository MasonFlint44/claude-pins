...
ACTIONS: list[Action] = [
    ...
    Action("palette", "Actions palette", "ctrl-x", "pin", short="actions"),
    Action("edit", "Edit", "f2", "pin", ellipsis=True, short="edit"),
    Action("details", "Details", "alt-i", "pin", short="details"),
    ...
    Action("new", "New pin", "ctrl-t", "list", ellipsis=True, short="new"),
    ...
    Action("refresh", "Refresh", "ctrl-r", "list", bind="reload"),
